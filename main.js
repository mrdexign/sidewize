...
const defaultConfig = {
	...
	chatService: 'deepseek', // Options: 'deepseek', 'gemini', 'grok', 'chatgpt'
};
...
const updateWindow = () => {
	...
	mainWindow = new BrowserWindow({
		...
		webPreferences: {
			...
			// Needed for some services to work properly
			webSecurity: false,
	...
	globalShortcut.register('CommandOrControl+G', () => toggleWindow());

	mainWindow?.setMinimumSize(windowWidth, screenHeight);
	mainWindow?.setMaximumSize(windowWidth, screenHeight);
